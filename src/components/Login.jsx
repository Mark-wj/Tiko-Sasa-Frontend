...
const Login = () => {
          ...
          const handleSubmit = async (e) => {
            ...
            if (res.ok) {
              ...
              // Save tokens (e.g., in localStorage or Context API)
              localStorage.setItem('accessToken', data.access);
              localStorage.setItem('refreshToken', data.refresh);
              setMessage('Login successful!');
              // Redirect to a protected route, update state, etc.
            } else {
    ...
    <div className="font-[sans-serif]" id="login">
      <div className="grid lg:grid-cols-3 md:grid-cols-2 items-center gap-4 h-full">
        ...
        <div className="w-full p-6 max-md:max-w-lg mx-auto">
          <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input name="email" type="text" required className="w-full text-sm text-gray-800 bg-gray-100 focus:bg-transparent pl-4 pr-10 py-3.5 rounded-md outline-blue-600" placeholder="Enter email"
            ...
            <div className="mt-4">
              ...
              <div className="relative flex items-center">
                <input name="password" type="password" required className="w-full text-sm text-gray-800 bg-gray-100 focus:bg-transparent pl-4 pr-10 py-3.5 rounded-md outline-blue-600" placeholder="********" 
            ...
            <div className="mt-8">
              <button type="submit" className="w-full py-3 px-4 text-sm tracking-wide rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                Sign in
              </button>
            </div>
